...
session_start();
$stmt = $mysql->prepare("SELECT * FROM `notable alumni`");
$stmt->execute();
...
<head>
    ...
    <title>Выдающиеся выпускники</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <img src="../assets/logo.png" style="width:30px;height:30px;border-radius: 0;"> <a class="navbar-brand" href="#">Музей МПК</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="notable_alumni.php">Выдающиеся выпускники</a>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <h1 style='font-weight:500; color:#323C8D;'>Выдающиеся выпускники</h1>
            <p>
                Фронтендер, добавь текст
            </p>
            <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] == true) { ?>
                <a href="../admin_panel/admin_alumni/add-alumni.php" class="new_alumni">Новый выпускник</a>
            <?php } ?>
        </div>
    </div>
    <div class="container">
                    ...
                    <div class="card" style="width: 18rem;" data-alumni-id="<?php echo $row['id']; ?>">
                        ...
                        <div class="card-body">
                            ...
                            <?php if (isset($_SESSION['admin']) && $_SESSION['admin'] == true) { ?>
                                ...
                                <center>
                                    <form action="../admin_panel/admin_alumni/delete-alumni.php" method="POST">
            ...
            <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <source src="../assets/mp3/1.mp3" type="audio/mpeg">
                        ...
                        <p style=' margin-top: 15px;font-size: 19px;line-height: 2;margin-bottom: 20px; font-weight:300'><?php echo $row['biography'] ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function goreduct(btn) {
            ...
            window.location.href = `../admin_panel/admin_alumni/reduct-alumni.php?id=${alumniId}`;
        }
        ...
        function confirmDelete() {
            return confirm("Подтвердите удаление выпускника?");
        }
    </script>
</body>
